<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recuperar.aspx.cs" Inherits="UTTT.Ejemplo.Persona.RecuperarContrasena" %>
...
<body>
    <form id="form1" runat="server" class="form-horizontal container">
        ...
        <%--Inicia Contrasena--%>
            <div class="row ">
                    <label class="col-sm-auto col-form-label" >Ingresa Contraseña:</label>
                    <asp:TextBox CssClass="form-control col-auto"  ID="txtContrasena" MinLength="3" MaxLength="15" runat="server"  Width="320px" ViewStateMode="Disabled" BorderStyle="Dotted" TextMode="Password"></asp:TextBox>
            </div>
            <br />
            <div class="row ">
                    <label class="col-sm-auto col-form-label" >Verificar contraseña:</label>
                    <asp:TextBox CssClass="form-control col-auto"  ID="txtContrasenaVerifi" MinLength="3" MaxLength="15" runat="server"  Width="320px" ViewStateMode="Disabled" BorderStyle="Dotted" TextMode="Password"></asp:TextBox>
            </div>
